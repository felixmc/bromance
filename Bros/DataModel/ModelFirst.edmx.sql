...
-- --------------------------------------------------
-- Date Created: 11/26/2013 15:46:29
-- Generated from EDMX file: C:\Users\ahomer\Documents\GitHub\bromance\Bros\DataModel\ModelFirst.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[bromance].[FK_CircleUser_Circle]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[CircleUser] DROP CONSTRAINT [FK_CircleUser_Circle];
GO
IF OBJECT_ID(N'[bromance].[FK_CircleUser_User]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[CircleUser] DROP CONSTRAINT [FK_CircleUser_User];
GO
IF OBJECT_ID(N'[bromance].[FK_UserUser_User]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[UserUser] DROP CONSTRAINT [FK_UserUser_User];
GO
IF OBJECT_ID(N'[bromance].[FK_UserUser_User1]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[UserUser] DROP CONSTRAINT [FK_UserUser_User1];
GO
IF OBJECT_ID(N'[bromance].[FK_InterestProfile_Interest]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[InterestProfile] DROP CONSTRAINT [FK_InterestProfile_Interest];
GO
IF OBJECT_ID(N'[bromance].[FK_InterestProfile_Profile]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[InterestProfile] DROP CONSTRAINT [FK_InterestProfile_Profile];
GO
IF OBJECT_ID(N'[bromance].[FK_RequestNotificationBroRequest]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications_RequestNotification] DROP CONSTRAINT [FK_RequestNotificationBroRequest];
GO
IF OBJECT_ID(N'[bromance].[FK_ProductCategory]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Products] DROP CONSTRAINT [FK_ProductCategory];
GO
IF OBJECT_ID(N'[bromance].[FK_ProductTag_Product]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[ProductTags] DROP CONSTRAINT [FK_ProductTag_Product];
GO
IF OBJECT_ID(N'[bromance].[FK_ProductTag_Tag]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[ProductTags] DROP CONSTRAINT [FK_ProductTag_Tag];
GO
IF OBJECT_ID(N'[bromance].[FK_PostComment]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Comments] DROP CONSTRAINT [FK_PostComment];
GO
IF OBJECT_ID(N'[bromance].[FK_UserPost]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Posts] DROP CONSTRAINT [FK_UserPost];
GO
IF OBJECT_ID(N'[bromance].[FK_UserProfile]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Users] DROP CONSTRAINT [FK_UserProfile];
GO
IF OBJECT_ID(N'[bromance].[FK_MessagesSent]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Messages] DROP CONSTRAINT [FK_MessagesSent];
GO
IF OBJECT_ID(N'[bromance].[FK_MessageUser]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Messages] DROP CONSTRAINT [FK_MessageUser];
GO
IF OBJECT_ID(N'[bromance].[FK_CircleOwner]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Circles] DROP CONSTRAINT [FK_CircleOwner];
GO
IF OBJECT_ID(N'[bromance].[FK_AlbumUser]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Albums] DROP CONSTRAINT [FK_AlbumUser];
GO
IF OBJECT_ID(N'[bromance].[FK_AlbumPhoto]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Posts_Photo] DROP CONSTRAINT [FK_AlbumPhoto];
GO
IF OBJECT_ID(N'[bromance].[FK_UserPreferences]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Preferences] DROP CONSTRAINT [FK_UserPreferences];
GO
IF OBJECT_ID(N'[bromance].[FK_SentBroRequest]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[BroRequests] DROP CONSTRAINT [FK_SentBroRequest];
GO
IF OBJECT_ID(N'[bromance].[FK_BroRequestUser]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[BroRequests] DROP CONSTRAINT [FK_BroRequestUser];
GO
IF OBJECT_ID(N'[bromance].[FK_SentFirstBump]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications_FirstBump] DROP CONSTRAINT [FK_SentFirstBump];
GO
IF OBJECT_ID(N'[bromance].[FK_CommentNotificationComment]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications_CommentNotification] DROP CONSTRAINT [FK_CommentNotificationComment];
GO
IF OBJECT_ID(N'[bromance].[FK_NotificationUser]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications] DROP CONSTRAINT [FK_NotificationUser];
GO
IF OBJECT_ID(N'[bromance].[FK_CommentUser]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Comments] DROP CONSTRAINT [FK_CommentUser];
GO
IF OBJECT_ID(N'[bromance].[FK_ProfilePhoto]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Posts_Photo] DROP CONSTRAINT [FK_ProfilePhoto];
GO
IF OBJECT_ID(N'[bromance].[FK_RequestNotification_inherits_Notification]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications_RequestNotification] DROP CONSTRAINT [FK_RequestNotification_inherits_Notification];
GO
IF OBJECT_ID(N'[bromance].[FK_Photo_inherits_Post]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Posts_Photo] DROP CONSTRAINT [FK_Photo_inherits_Post];
GO
IF OBJECT_ID(N'[bromance].[FK_FirstBump_inherits_Notification]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications_FirstBump] DROP CONSTRAINT [FK_FirstBump_inherits_Notification];
GO
IF OBJECT_ID(N'[bromance].[FK_CommentNotification_inherits_Notification]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Notifications_CommentNotification] DROP CONSTRAINT [FK_CommentNotification_inherits_Notification];
GO
IF OBJECT_ID(N'[bromance].[FK_TextPost_inherits_Post]', 'F') IS NOT NULL
    ALTER TABLE [bromance].[Posts_TextPost] DROP CONSTRAINT [FK_TextPost_inherits_Post];
GO
...
IF OBJECT_ID(N'[bromance].[Albums]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Albums];
GO
IF OBJECT_ID(N'[bromance].[Users]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Users];
GO
IF OBJECT_ID(N'[bromance].[Posts]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Posts];
GO
IF OBJECT_ID(N'[bromance].[Comments]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Comments];
GO
IF OBJECT_ID(N'[bromance].[BroRequests]', 'U') IS NOT NULL
    DROP TABLE [bromance].[BroRequests];
GO
IF OBJECT_ID(N'[bromance].[Circles]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Circles];
GO
IF OBJECT_ID(N'[bromance].[Interests]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Interests];
GO
IF OBJECT_ID(N'[bromance].[Messages]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Messages];
GO
IF OBJECT_ID(N'[bromance].[Notifications]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Notifications];
GO
IF OBJECT_ID(N'[bromance].[Preferences]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Preferences];
GO
IF OBJECT_ID(N'[bromance].[Products]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Products];
GO
IF OBJECT_ID(N'[bromance].[Tags]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Tags];
GO
IF OBJECT_ID(N'[bromance].[Categories]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Categories];
GO
IF OBJECT_ID(N'[bromance].[Profiles]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Profiles];
GO
IF OBJECT_ID(N'[bromance].[Notifications_RequestNotification]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Notifications_RequestNotification];
GO
IF OBJECT_ID(N'[bromance].[Posts_Photo]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Posts_Photo];
GO
IF OBJECT_ID(N'[bromance].[Notifications_FirstBump]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Notifications_FirstBump];
GO
IF OBJECT_ID(N'[bromance].[Notifications_CommentNotification]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Notifications_CommentNotification];
GO
IF OBJECT_ID(N'[bromance].[Posts_TextPost]', 'U') IS NOT NULL
    DROP TABLE [bromance].[Posts_TextPost];
GO
IF OBJECT_ID(N'[bromance].[CircleUser]', 'U') IS NOT NULL
    DROP TABLE [bromance].[CircleUser];
GO
IF OBJECT_ID(N'[bromance].[UserUser]', 'U') IS NOT NULL
    DROP TABLE [bromance].[UserUser];
GO
IF OBJECT_ID(N'[bromance].[InterestProfile]', 'U') IS NOT NULL
    DROP TABLE [bromance].[InterestProfile];
GO
IF OBJECT_ID(N'[bromance].[ProductTags]', 'U') IS NOT NULL
    DROP TABLE [bromance].[ProductTags];
GO
